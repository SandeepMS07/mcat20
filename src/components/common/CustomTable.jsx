  ...
  return (
    <div className="w-full overflow-auto">
      <table className="w-full table-auto  border-collapse text-sm relative">
        ...
        <thead className="bg-[#999FA4] m-1 italic z-50 relative mb-4 mr-2 custom-heading-border"
           style={{
        ...
        >
          <div className="grid  grid-cols-[2fr_repeat(7,1fr)]"> {/* or flex or table if fixed layout */}
